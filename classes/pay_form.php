...
class pay_form extends \moodleform
{
    public function definition()
    {
        ...
        $mform->addElement('text', 'codice_buono', get_string('insert_voucher_code', 'paygw_docente'));
        $mform->setType('codice_buono', PARAM_TEXT);
        $mform->addRule('codice_buono', get_string('error_being', 'paygw_docente'), 'required', '', 'client', false, false);
