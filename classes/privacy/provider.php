...
/**
 * Privacy Subsystem implementation for paygw_docente.
 *
 * @package   paygw_docente
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */

namespace paygw_docente\privacy;
...
class provider implements \core_privacy\local\metadata\null_provider, paygw_provider
{
    ...
    public static function export_payment_data(\context $context, array $subcontext, \stdClass $payment)
    {
        ...
        $subcontext[] = get_string('gatewayname', 'paygw_docente');
        $record = $DB->get_record('paygw_docente', ['paymentid' => $payment->id]);
    ...
    public static function delete_data_for_payment_sql(string $paymentsql, array $paymentparams)
    {
        ...
        $DB->delete_records_select('paygw_docente', "paymentid IN ({$paymentsql})", $paymentparams);
    }
}
