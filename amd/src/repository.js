...
/**
 * docente repository module to encapsulate all of the AJAX requests that can be sent for docente.
 *
 * @module     paygw_docente/repository
...
/**
 * Return the docente JavaScript SDK URL.
 *
...
export const getConfigForJs = (component, paymentArea, itemId) => {
    const request = {
        methodname: 'paygw_docente_get_config_for_js',
        args: {
            component,
